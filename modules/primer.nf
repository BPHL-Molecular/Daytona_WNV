process primer {
    ...
    singularity exec docker://staphb/ivar:1.3.2 ivar trim -i ${mypath}/alignment/\${samplename}.sorted.bam  -b ${params.primer}/WNVUS.bed -p ${mypath}/alignment/\${samplename}.primertrim -e
